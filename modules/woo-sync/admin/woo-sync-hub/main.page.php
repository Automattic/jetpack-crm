...
function jpcrm_woosync_render_hub_page() {
	...
	if ( count( $sync_sites ) > 1 ) {
		...
		// count them
		$wc_setup_type_text .= sprintf( __( ' (%1$d active and %2$d paused)', 'zero-bs-crm' ), $total_active_connections, count( $sync_sites ) - $total_active_connections );
	...
	<div id="jpcrm-woosync-hub-page">
				...
				<div class="ui grid" id="jpcrm-woosync-stats-container">
					<div class="five wide column">
						<div class="jpcrm-woosync-stat ui inverted segment blue">
							<div class="jpcrm-woosync-stat-container jpcrm-clickable" data-href="<?php echo esc_attr( zeroBSCRM_getAdminURL( $zbs->slugs['managecontacts'] . '&quickfilters=woo_customer' ) ); ?>"
							<?php
					...
					<div class="five wide column">
						<div class="jpcrm-woosync-stat ui inverted segment blue">
							<div class="jpcrm-woosync-stat-container jpcrm-clickable" data-href="<?php echo esc_attr( zeroBSCRM_getAdminURL( $zbs->slugs['managetransactions'] . '&quickfilters=woo_transaction' ) ); ?>"
							<?php
								// basic style scaling for large numbers.
								// On refining this hub page we should rethink
					...
					<div class="five wide column">
						<div class="jpcrm-woosync-stat ui inverted segment blue">
							<div class="jpcrm-woosync-stat-container"
							<?php
		...
		<div id="jpcrm-woosync-quiet-restart-link">
			...
			if ( zeroBSCRM_isZBSAdminOrAdmin() ) {
				?>
				<a href="<?php echo esc_url( $settings_page_url ); ?>"><?php esc_html_e( 'WooSync Settings', 'zero-bs-crm' ); ?></a> | <a href="<?php echo esc_url( $connections_page_url ); ?>"><?php esc_html_e( 'WooSync Connections', 'zero-bs-crm' ); ?></a> 
				<?php
			}
			?>
