	...
	*/
	public function catch_google_mail_authorisation() {
		...
		if ( ! empty( $_GET['error'] ) ) {
			...
			$authorisation_url       = $provider->getAuthorizationUrl(
				array(
					'prompt'      => 'consent',
					'access_type' => 'offline',
				)
	...
	*/
	public function refresh_token( $provider_key, $provider_config = false ) {
		...
		try {
			...
			$new_token = $provider->getAccessToken(
				'refresh_token',
				array(
	...
	*/
	public function refresh_token_google_mail( $provider_config = false ) {
		...
		try {
			...
			$new_token         = $provider->getAccessToken( $grant, array( 'refresh_token' => $provider_config['refresh_token'] ) );
			$new_refresh_token = $new_token->getRefreshToken();
