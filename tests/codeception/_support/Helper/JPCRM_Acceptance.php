...
class JPCRM_Acceptance extends WPBrowser {
	...
	public function run_server() {
		...
		// PHP 8.4.19+ and 8.5.5+ inconsistently segfault here in CI. Disabling opcache.jit seems to fix it. p1773618372849869-slack-C034JEXD1RD
		$serverCmd = "php -dopcache.jit=disable -S $server_host -t $wp_path";
